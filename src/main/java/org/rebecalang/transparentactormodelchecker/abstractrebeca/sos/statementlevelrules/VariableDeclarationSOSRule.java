...
@Component
public class VariableDeclarationSOSRule extends AbstractSOSRule<Pair<? extends AbstractActorState, InstructionBean>> {
	...
	public DeterministicTransition<Pair<? extends AbstractActorState, InstructionBean>> 
		...
		DeclarationInstructionBean vdib = (DeclarationInstructionBean) state.getSecond();
		state.getFirst().addVariableToScope(vdib.getVarName());
