...
@Component
public class PopSOSRule extends AbstractSOSRule<Pair<? extends AbstractActorState, InstructionBean>> {
	...
	public DeterministicTransition<Pair<? extends AbstractActorState, InstructionBean>> 
		...
		PopARInstructionBean pib = (PopARInstructionBean) state.getSecond();
	...
	@Override
	public DeterministicTransition<Pair<? extends AbstractActorState, InstructionBean>> 
			applyRule(Pair<? extends AbstractActorState, InstructionBean> base, Action action, Pair<? extends AbstractActorState, InstructionBean> state) {
